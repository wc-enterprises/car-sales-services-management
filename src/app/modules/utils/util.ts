...
export const Makes: Record<string, string[]> = {
  ...
  Cupra: ["Cupra", "Formentor", "Leon", "Ateca"],
  Dacia: [
    "1300",
    "1310",
    "1310 Touring",
  ...
  Ds: ["3", "4", "5", "6"],
  Fiat: ["500", "500X", "500L", "Panda", "Punto", "Qubo"],
  ...
  Jaecoo: ["Jaecoo"],
  Jeep: ["Cherokee", "Compass", "Gladiator", "Liberty", "Patriot", "Wrangler"],
  Kia: [
    "Ceed",
    "K5",
    "Niro",
...
export const MakesList2: Record<string, string[]> = {
  Chrysler: ["300", "Pacifica", "Voyager", "Aspen", "Crossfire", "Sebring"],
  Dodge: ["Charger", "Challenger", "Durango", "Journey", "Viper", "Dart"],
  Chevrolet: [
    "Camaro",
    "Corvette",
    "Equinox",
  ...
  Cadillac: ["Escalade", "XT5", "CT6", "CTS", "SRX", "DTS"],
  Ford: ["Mustang", "F-150", "Explorer", "Fusion", "Escape", "Bronco"],
  GMC: ["Sierra", "Yukon", "Terrain", "Canyon", "Acadia", "Savanna"],
  ...
  Jaguar: ["XE", "XF", "XJ", "F-Type", "E-Pace", "I-Pace"],
  "Land Rover": [
    "Range Rover",
    "Discovery",
    "Defender",
  ...
  "Aston Martin": ["DB11", "Vantage", "DBS", "Rapide", "Valhalla", "Valkyrie"],
  Porsche: ["911", "Cayenne", "Macan", "Taycan", "Panamera", "Boxster"],
  Ferrari: ["488", "Roma", "Portofino", "812 Superfast", "SF90", "F8 Tributo"],
  Toyota: ["Corolla", "Camry", "RAV4", "Highlander", "Land Cruiser", "Supra"],
  Zenvo: ["TSR-S", "ST1"],
  Wiesmann: ["GT MF4", "MF5"],
  Suzuki: ["Swift", "Vitara", "Jimny", "S-Cross"],
  Subaru: ["Outback", "Forester", "Impreza", "Crosstrek", "BRZ"],
  Rivian: ["R1T (truck)", "R1S (SUV)"],
  Opel: ["Astra", "Corsa", "Mokka", "Grandland X"],
  Nio: ["ES8", "ES6", "EC6", "ET7"],
  Nissan: ["Altima", "Maxima", "Rogue", "GT-R", "Juke", "Leaf"],
  McLaren: ["570S", "720S", "GT", "Artura"],
  Mitsubishi: ["Outlander", "Eclipse Cross", "ASX", "Pajero"],
  Maserati: ["Ghibli", "Levante", "Quattroporte", "MC20"],
  Lotus: ["Evora", "Elise", "Exige"],
  Lincoln: ["Navigator", "Aviator", "Continental", "MKC"],
  Lamborghini: ["Huracán", "Aventador", "Urus", "Sian"],
  Lexus: ["RX", "NX", "ES", "LS", "LC", "UX"],
  Acura: ["MDX", "TLX", "NSX", "RDX", "ILX"],
  Buick: ["Enclave", "Encore", "LaCrosse", "Regal"],
  Citroën: ["C3", "C4", "C5 Aircross", "Berlingo"],
  Daihatsu: ["Terios", "Copen", "Move"],
  Infiniti: ["Q50", "QX60", "QX80", "QX55"],
  Isuzu: ["D-Max", "MU-X"],
